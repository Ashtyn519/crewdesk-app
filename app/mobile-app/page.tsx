      ...
      <section className="py-24 px-6 bg-[#040A16] border-y border-[#1A2540]">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            ...
            <h2 className="text-4xl md:text-5xl font-black tracking-tight mb-6">Built for<br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-200">business</span></h2>
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400">Join studios and agencies running their workforce on CrewDesk</p>
          </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-4xl md:text-5xl font-black tracking-tight mb-4">Download CrewDesk today</h2>
            <p className="text-slate-400 text-lg mb-10">Available on iOS and Android. Start free, no credit card required.</p>
            <div className="flex flex-wrap gap-4 justify-center mb-8">
              <motion.a href="https://apps.apple.com" target="_blank" rel="noopener noreferrer" whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="flex items-center gap-3 bg-white text-black px-8 py-4 rounded-xl font-bold hover:bg-slate-100 transition-colors shadow-lg shadow-white/10">
              ...
              <motion.a href="https://play.google.com" target="_blank" rel="noopener noreferrer" whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="flex items-center gap-3 bg-[#0A1020] text-white px-8 py-4 rounded-xl font-bold border border-[#1A2540] hover:border-[#243050] transition-colors shadow-lg">
            ...
            <p className="text-slate-500 text-sm">
              Questions?{' '}
              <a href="mailto:info@crewdeskapp.com" className="text-amber-400 hover:text-amber-300 transition-colors">Contact us</a>
            </p>
          </motion.div>
        </div>
      </section>
