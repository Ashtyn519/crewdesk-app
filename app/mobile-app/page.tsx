...
const TESTIMONIALS = [
  ...
  { name: 'James Okafor', role: 'Founder, PixelForge', text: 'Approving invoices on the go, checking crew status between takes. I cannot imagine working without it.', rating: 5 },
                                ...
                                <div>
                                            ...
                                            <motion.div
                                                          ...
                                                          <motion.a
                                                                            ...
                                                                            whileTap={{ scale: 0.97 }}
                                                                            className="flex items-center gap-3 bg-white text-black px-6 py-3.5 rounded-xl font-semibold hover:bg-slate-100 transition-colors shadow-lg"
                                                                          >
                                                                          <Apple className="w-5 h-5" />
                                                                          <div className="text-left">
                                                                                            <div className="text-[10px] text-slate-500 leading-none">Download on the</div>div>
                                                                                            <div className="text-sm font-bold">App Store</div>div>
                                                                          </div>div>
                                                          </motion.a>motion.a>
                                                          <motion.a
                                                                            ...
                                                                            whileHover={{ scale: 1.03 }}
                                                                            whileTap={{ scale: 0.97 }}
                                                                            className="flex items-center gap-3 bg-[#0A1020] text-white px-6 py-3.5 rounded-xl font-semibold border border-[#1A2540] hover:border-[#243050] transition-colors shadow-lg"
                                                                          >
                                                                          <Play className="w-5 h-5" />
                                                                          <div className="text-left">
                                                                                            <div className="text-[10px] text-slate-500 leading-none">Get it on</div>div>
                                                                                            <div className="text-sm font-bold">Google Play</div>div>
                                                                          </div>div>
                                                          </motion.a>motion.a>
                                            </motion.div>motion.div>
                                            <motion.div
                                                          ...
                                                          <div className="w-full h-full rounded-[36px] bg-[#04080F] overflow-hidden">
                                                                          ...
                                                                          <div className="px-4 pb-4 pt-1">
                                                                                            ...
                                                                                            <div className="grid grid-cols-2 gap-2 mb-4">
                                                                                              {[
                                              { label: 'Revenue', v: '48k', color: 'text-amber-400' },
                                              { label: 'Projects', v: '12', color: 'text-blue-400' },
                                              { label: 'Crew', v: '28', color: 'text-purple-400' },
                                              { label: 'Invoices', v: '5', color: 'text-emerald-400' },
                                                                  ].map(s => (
                                                                            ...
                                                                            {[
                                              { name: 'Brand Refresh', pct: 72 },
                                              { name: 'App Prototype', pct: 45 },
                                              { name: 'Marketing Push', pct: 88 },
                                                                ].map((p) => (
                      ...
                      <div className="max-w-6xl mx-auto">
                                <div className="text-center mb-16">
                                            ...
                                            <motion.h2
                                                          ...
                                                          >One app. Total control.</motion.h2>motion.h2>
                                            <motion.p
                                                            initial={{ opacity: 0 }}
                                                            whileInView={{ opacity: 1 }}
                                                            viewport={{ once: true }}
                                                            className="text-slate-400 text-lg max-w-2xl mx-auto"
                                                          >Every CrewDesk feature, optimised for mobile with a native feel and offline-first architecture.</motion.p>motion.p>
                                </div>div>
                      ...
                      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
                                <motion.div
                                            ...
                                            <p className="text-slate-400 text-lg leading-relaxed mb-8">
                                                          Bank-grade encryption, biometric authentication, and role-based access controls. Your crew data is safe whether on set or in the office.
                                            </p>p>
                                ...
                                <motion.div
                                            ...
                                            >
                                  {[
                                              { icon: Shield, label: 'Bank-grade encryption', color: 'blue' },
                                              { icon: Wifi, label: 'Offline-first sync', color: 'green' },
                                              { icon: Bell, label: 'Smart notifications', color: 'amber' },
                                              { icon: Users, label: 'Role-based access', color: 'purple' },
                                                          ].map((item, i) => {
                                                                          ...
                                                                          return (
                                                                                            <motion.div
                                                                                                                ...
                                                                                                                viewport={{ once: true }}
                                                                                                                transition={{ delay: i * 0.1 }}
                                                                                                                className="p-6 rounded-2xl bg-[#0A1020] border border-[#1A2540] text-center"
                                                                                                              >
                      ...
                      <div className="max-w-4xl mx-auto text-center">
                                <motion.div
                                            ...
                                            <div className="relative z-10">
                                                          ...
                                                          <h2 className="text-4xl font-black tracking-tight mb-4">Ready to take CrewDesk mobile?</h2>h2>
                                                          <p className="text-slate-400 text-lg mb-8 max-w-2xl mx-auto">
                                                                          Download the app today. Free forever, upgrade when you are ready.
                                                          </p>p>
                                                          <div className="flex flex-wrap gap-4 justify-center mb-6">
                                                                          <motion.a
                                                                                              ...
                                                                                              whileHover={{ scale: 1.03 }}
                                                                                              whileTap={{ scale: 0.97 }}
                                                                                              className="flex items-center gap-3 bg-white text-black px-7 py-4 rounded-xl font-bold text-base hover:bg-slate-100 transition-colors shadow-lg"
                                                                                            >
                                                                                            <Apple className="w-5 h-5" />
                                                                                            <div className="text-left">
                                                                                                                <div className="text-[10px] text-slate-500 leading-none">Download on the</div>div>
                                                                                                                <div className="font-bold">App Store</div>div>
                                                                                              </div>div>
                                                                          </motion.a>motion.a>
                                                                          <motion.a
                                                                                              href="https://play.google.com"
                                                                                              ...
                                                                                              whileHover={{ scale: 1.03 }}
                                                                                              whileTap={{ scale: 0.97 }}
                                                                                              className="flex items-center gap-3 bg-[#0A1020] text-white px-7 py-4 rounded-xl font-bold text-base border border-[#1A2540] hover:border-[#243050] transition-colors shadow-lg"
                                                                                            >
                                                                                            <Play className="w-5 h-5" />
                                                                                            <div className="text-left">
                                                                                                                <div className="text-[10px] text-slate-500 leading-none">Get it on</div>div>
                                                                                                                <div className="font-bold">Google Play</div>div>
                                                                                              </div>div>
                                                                          </motion.a>motion.a>
                                                          </div>div>
                                                          <Link href="/signup">
