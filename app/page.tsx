              ...
              <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
                      ...
                      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
                                ...
                                <motion.h1
                                            ...
                                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-200">for your freelance workforce</span>span>
                                </motion.h1>motion.h1>
                                <motion.p
                                              initial={{ opacity: 0, y: 20 }}
                                              animate={{ opacity: 1, y: 0 }}
                                ...
                                <motion.div
                                            ...
                                            <CheckCircle className="w-4 h-4 text-emerald-400" /> 14-day free trial on all paid plans · No credit card required · Cancel anytime
                                </motion.div>motion.div>
                      </div>div>
              </section>section>
              ...
              <section ref={featuresRef} id="features" className="py-24 px-6">
                      <div className="max-w-6xl mx-auto">
                                <div className="text-center mb-16">
                                            ...
                                            <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-4xl md:text-5xl font-black tracking-tight mb-4">One platform. Total control.</motion.h2>motion.h2>
                                            <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="text-slate-400 text-lg max-w-2xl mx-auto">Stop juggling spreadsheets, emails, and invoicing tools. CrewDesk brings it all under one roof.</motion.p>motion.p>
                                </div>div>
                      ...
                      <div className="max-w-6xl mx-auto">
                                <div className="grid md:grid-cols-2 gap-16 items-center">
                                            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                                                          ...
                                                          <h2 className="text-4xl md:text-5xl font-black tracking-tight mb-6">Your workforce in <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-200">your pocket</span>span></h2>h2>
                                                          <p className="text-slate-400 text-lg leading-relaxed mb-8">The full power of CrewDesk, optimised for mobile. Review projects, approve invoices, message your crew, and track contracts anywhere, anytime.</p>p>
                      ...
                      <div className="max-w-4xl mx-auto text-center">
                                <motion.div
                                            ...
                                            <div className="relative z-10">
                                                          ...
                                                          <p className="text-slate-400 text-lg mb-8 max-w-2xl mx-auto">Start managing your freelance workforce like a world-class operation. 14-day free trial on all paid plans, upgrade when you are ready.</p>p>
                                                          <Link href="/signup">
