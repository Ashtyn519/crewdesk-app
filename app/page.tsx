...
import { 
  Zap, Users, FolderKanban, Receipt, FileText, 
  MessageSquare, ArrowRight, CheckCircle, Star,
  Smartphone, Apple, Play, TrendingUp, Shield, Globe
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#04080F] text-white overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-[#04080F]/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            {['Features', 'Pricing', 'Mobile App', 'Blog'].map(item => (
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          >
            Manage projects, crew, invoices, and contracts in one place. 
            Built for agencies and studios that run on freelance talent.
          </motion.p>
      ...
      <section ref={featuresRef} className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            >One platform. Total control.</motion.h2>
            <motion.p
              initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
              className="text-slate-400 text-lg max-w-2xl mx-auto"
            >Stop juggling spreadsheets, emails, and invoicing tools. CrewDesk brings it all under one roof.</motion.p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 mb-6">
                ...
                <span className="text-xs font-semibold text-blue-400 uppercase tracking-wide">iOS Priority</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-black tracking-tight mb-6">
                Your workforce in
                <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-200">your pocket</span>
              </h2>
              <p className="text-slate-400 text-lg leading-relaxed mb-8">
                The full power of CrewDesk, optimised for mobile. Review projects, approve invoices, 
                message your crew, and track contracts — anywhere, anytime.
              </p>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-slate-400 text-lg mb-8 max-w-2xl mx-auto">
                Start managing your freelance workforce like a world-class operation. 
