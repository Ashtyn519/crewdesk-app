...
import {
  Users, FileText, Receipt, MessageSquare,
  ArrowRight, Eye, EyeOff, Zap, Shield, BarChart3, Sparkles
} from 'lucide-react'
    ...
    <div className="min-h-screen bg-[#04080F] flex overflow-hidden relative">
      ...
      <div className="hidden lg:flex flex-col justify-between w-[52%] px-16 py-14 relative z-10">
        ...
        <div className="flex-1 flex flex-col justify-center max-w-lg">
          ...
          <motion.h1 initial={{ opacity:0, y:24 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.65, delay:0.22, ease:[0.22,1,0.36,1] }}
            ...
            Your freelance<br />
            <span className="text-amber-400">workforce,</span><br />
            fully in control.
          </motion.h1>
          ...
          <motion.div initial="hidden" animate="show"
            ...
            {features.map(f => (
              <motion.div key={f.label}
                ...
                className="flex items-start gap-3 p-3.5 rounded-2xl bg-white/[0.03] border border-white/[0.06] hover:border-white/[0.1] transition-colors">
        ...
        <motion.div initial={{ opacity:0 }} animate={{ opacity:1 }} transition={{ duration:0.6, delay:0.9 }}
          ...
          <p className="text-white/35 text-xs">Trusted by <span className="text-white/60 font-medium">2,400+</span> production teams</p>
        </motion.div>
      </div>
      ...
      <div className="flex-1 lg:w-[48%] flex items-center justify-center px-8 py-14 relative z-10">
        <div className="w-full max-w-[400px]">
          ...
          <motion.div initial={{ opacity:0, y:24 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.55, delay:0.1, ease:[0.22,1,0.36,1] }}>
